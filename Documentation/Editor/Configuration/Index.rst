...
:ref:`services <for-editors-service>` are referenced via this configuration.
After the record has been created, reference it in the :ref:`Site Configuration
<for-editors-site-configuration>`.
